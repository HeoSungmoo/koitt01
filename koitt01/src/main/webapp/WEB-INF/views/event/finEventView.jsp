...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="mypage">
					<h2><strong>종료된 이벤트</strong><span>이벤트 끝났엉</span></h2>
...
<!-- 									<td><a href="finEventView?event_no=${finEventViewPre.event_no }& end_date=${finEventViewPre.end_date}">${finEventViewPre.title }</a></td> --%>
<!-- 									<td>&nbsp;</td> -->
<!-- 								</tr> -->

<!-- 								<tr> -->
<!-- 									<th class="next">NEXT</th> -->
<!-- 									<td><a href="finEventView?event_no=${finEventViewNext.event_no }& end_date=${finEventViewNext.end_date}">${finEventViewNext.title }</a></td> --%>
<!-- 									<td>&nbsp;</td> -->
<!-- 								</tr> -->
<!-- 							</tbody> -->
						</table>
