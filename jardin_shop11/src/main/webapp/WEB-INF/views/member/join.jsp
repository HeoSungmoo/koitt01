...
function check(){
	...
	var nameChk = /^[가-힣]{2,6}$/;
	var idChk = /^(?=,*[a-zA-Z]{1})(?=.*[a-zA-Z]})(?=.*[0-9])(?=.*[~!@#$%^&*()+|]).{4,16}$/;
	var passChk = /^(?=,*[a-zA-Z])(?=.*[0-9]).{4,20}$/;	
	var phoneChk = /^[0-9]{4}$/;
	var telchk = /^[0-9]{3}$/;
	
	
	if(userInfo.m_name.value=""){
		alert("이름을 입력하세요");
		userInfo.name.focus();
		return false;
	...
	if(!(nameChk.test(userInfo.m_name.value))){
		alert("이름은 한글로 6글자 이하로 입력되야 합니다");
		userInfo.name.value="";
		userInfo.name.foucs();
		return false;
	}
	...
	if(userInfo.m_id.value=""){
		alert("아이디를 입력하세요");
		userInfo.m_id.focus();
		return false;
	}
	if(!(idChk.test(userInfo.m_id.value))){
		alert("첫 글자는 영문으로 4~16자 까지 가능, 영문, 숫자와 특수기호(_)만 사용 가능합니다");
		userInfo.m_id.value="";
		userInfo.m_id.focus();
		return false;
	}
				...
				<div id="member">
					...
					<div class="memberbd">
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
							<form action="userInfo" method="post" name="userInfo" id="userInfo">
								<tr>
									<th scope="row"><span>이름 *</span></th>
									<td><input type="text" name="m_name" class="w134" /></td>
								</tr>
								<tr>
									...
									<td>
										...
										<ul class="pta">
											<li class="r10"><input type="text" name="m_id" class="w134" /></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password" name="m_pass" class="w134" /></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password" name="pass2" class="w134" /></li>
											<li>
								...
								<tr>
									...
									<td>
										...
										<ul class="question">
											<li>
												<input type="radio" name="mail_send" id="receive_yes" class="radio_t" checked="checked"/><label for="receive_yes">예</label>
											</li>
											<li>
												<input type="radio" name="mail_send" id="receive_no" class="radio_t"/><label for="receive_no">아니오</label>
											</li>
										</ul>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li>
												<input type="text" name="zip" class="w134" />&nbsp;
											</li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>&nbsp;<span class="valign">-</span>&nbsp;</li>
											<li><input type="text" class="w74" name="phone2 maxlength="4" /> <span class="valign">-</span>&nbsp;</li>
											<li class="r10"><input type="text" name="phone3" class="w74" maxlength="4" /></li>
