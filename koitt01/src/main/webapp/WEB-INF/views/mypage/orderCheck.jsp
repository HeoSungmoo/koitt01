				...
				<div id="outbox">
					<div id="left">
						...
						<ul>
							...
							<li><a href="inquiry?id=${member}" id="leftNavi7">1:1문의</a></li>
					...
					<div id="contents">
						<div id="mypage">
							<h2>
								<strong>주문/배송 조회</strong><span>회원님이 구매하신 주문내역 및 배송정보를
									확인하실 수 있습니다.</span>
							</h2>
							...
							<h3>주문/배송 조회</h3>
							<div class="checkDiv">
								<table summary="기간별, 상태별, 단어검색별로 주문/배송 조회를 하실수 있습니다."
								...
								<table summary="주문일자/주문번호, 상품명, 가격, 수량, 주문상태 순으로 조회를 하실수 있습니다."
									...
									<tbody>
										<tr>
											...
											<td class="left">쟈뎅 오리지널 콜롬비아 페레이라 원두커피백 15p</td>
											<td class="tnone">999,999 원</td>
											<td class="tnone">1000개</td>
											<td><span class="heavygray">배송완료</span>
												<ul class="state">
													<li class="r5"><a href="return.html"
														class="obtnMini iw40">교환</a></li>
										...
										<tr>
											...
											<td class="tnone">999,999 원</td>
											<td class="tnone">1000개</td>
											<td><span class="lightgray">입금대기중</span>
												<ul class="state">
										...
										<tr>
											...
											<td class="tnone">999,999 원</td>
											<td class="tnone">1000개</td>
											<td><span class="lightgray">입금완료</span>
												<ul class="state">
													<li><a href="#" class="nbtnMini iw83">취소</a></li>
												</ul></td>
										</tr>
										...
										<tr>
											...
											<td class="tnone">999,999 원</td>
											<td class="tnone">1000개</td>
											<td><span class="orange">배송중</span></td>
										</tr>
										...
										<tr>
											...
											<td class="tnone">999,999 원</td>
											<td class="tnone">1000개</td>
											<td><span class="orange">배송준비중</span></td>
										</tr>
									</tbody>
								</table>
							...
							<div class="productTab">
								<ul>
									<li><a href="javascript:;" onclick="return false;"
										id="tab_today">오늘 본 상품 <span>(4)</span></a></li>
									<li class="last"><a href="javascript:;"
										onclick="return false;" id="tab_basket">장바구니 <span>(0)</span></a></li>
								</ul>
							</div>
							<script type="text/javascript">
								$(function() {
							...
							<div class="tab_today disnone">
								...
								<div class="productList">
									<ul>
										<!-- Product Yes -->
										<li><span class="chk"><input type="checkbox" /></span> <span
											class="img"><img src="images/img/sample_product.jpg"
												alt="상품" /></span> <span class="name"><a href="#">쟈뎅
													오리지널 블루마운틴 블렌드 원두커피백 15P</a></span> <span class="price">4,330원</span>
										</li>
								...
								<div class="productList">
									<ul>
										...
										<li><span class="chk"><input type="checkbox" /></span> <span
											class="img"><img src="images/img/sample_product.jpg"
												alt="상품" /></span> <span class="name"><a href="#">쟈뎅
													장바구니 블루마운틴 블렌드 원두커피백 15P</a></span> <span class="price">4,330원</span>
										</li>
							...
							<script type="text/javascript">
								$(function() {
									function distance() {
										...
										if (winWidth > 767) {
											$(
													".productList ul li:nth-child(4n+4)")
													.css("padding", "0 0 0 0");
										} else {
											$(
													".productList ul li:nth-child(4n+4)")
