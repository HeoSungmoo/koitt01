				...
				<div id="outbox">
					<div id="left">
						...
						<ul>
							...
							<li class="last"><a href="prizeWinner" id="leftNavi3">당첨자
									발표</span>
							</a></li>
						</ul>
					</div>
						...
						<div id="mypage">
							...
							<div class="viewDivMt">
								<div class="viewHead">
									...
									<div class="day">
										<p class="txt">
											이벤트 기간<span>${eventView.start_date } ~
												${eventView.end_date}</span>
										</p>
									</div>
								</div>
								...
								<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext"
									...
									<tbody>
										<tr>
											...
											<td><a
												href="eventView?event_no=${eventViewPre.event_no} ">${eventViewPre.title}</a></td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											...
											<td><a
												href="eventView?event_no=${eventViewNext.event_no} & end_date=${eventViewNext.end_date}">${eventViewNext.title}</a></td>
											<td>&nbsp;</td>
										</tr>
									</tbody>
								</table>
							...
							<form action="eventCommentWrite?event_no=${eventView.event_no}"
								method="post" name=eventCommentForm>
								<!-- 댓글-->
								<div class="replyWrite">
									<ul>
										<li class="in">
											<p class="txt">
												총 <span class="orange"></span> 개의 댓글이 달려있습니다.
											</p> <textarea class="replyType" name="comment_content"></textarea>
										</li>
							...
							<c:forEach var="EventComment" items="${eventComment }">
								<div class="replyBox">
									...
									<ul>
										...
										<li class="btn"><a
											href="eventCommentModifyView?comment_no=${EventComment.comment_no }&event_no=${eventView.event_no}"
											class="rebtn">수정</a> <a
											href="eventCommentDelete?comment_no=${EventComment.comment_no }&event_no=${eventView.event_no}"
											class="rebtn">삭제</a></li>
									</ul>
