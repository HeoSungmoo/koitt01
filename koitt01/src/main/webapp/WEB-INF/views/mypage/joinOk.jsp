...
<tr>
	<td style="width:700px;height:78px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:50px 0 40px 38px;text-align:center;font-size:0;line-height:0;"><img src="../images/email/img_txt_join01.jpg" alt="원두커피의 名家, JARDIN 회원가입을 축하드립니다." /></p>
	</td>
</tr>
<tr>
	<td style="width:700px;height:127px;padding:0;margin:0;vertical-align:top;">
		...
		<tr>
			<td style="width:618px;height:125px;padding:0;margin:0;vertical-align:top;font-size:0;line-height:0;background:#f9f9f9;">
				<p style="width:620px;margin:30px 0 0 0;padding:0;text-align:center;vertical-align:top;"><span style="color:#f7703c; font-size:15px;line-height:1.2;vertical-align:top;"><strong>홍길동</strong>&nbsp;</span><img src="../images/email/img_txt_join02.jpg" alt="님 쟈뎅샵에 가입해 주셔서 감사드립니다." /></p>
